...
Backend اتوماسیون مرورگر در سطح Enterprise مبتنی بر **Node.js + TypeScript**.

> این مخزن نسخه‌ی بازیابی‌شده از یک بکاپ قدیمی است که اکنون در حال **پاک‌سازی، رفع باگ، و سازگارسازی با محیط Node-base/Linux** و افزودن **رابط کاربری** است.
> نقشه‌ی راه و لیست کامل باگ‌ها در فایل [`PLAN.md`](./PLAN.md) قرار دارد.

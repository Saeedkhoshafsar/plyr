...
(function () {
  ...
  var DICT = {
    fa: {
      ...
      'fe.steps': 'مرحله',
      'fe.hint': 'راهنما: روی یک نود برای انتخاب کلیک کنید · پس‌زمینه را بکشید تا جابه‌جا شوید · چرخ ماوس برای زوم · کلیک روی یک لبه آن را حذف می‌کند.',
    ...
    en: {
      ...
      'fe.steps': 'step(s)',
      'fe.hint': 'Tip: click a node to select \u00b7 drag the background to pan \u00b7 mouse wheel to zoom \u00b7 click an edge to delete it.',
